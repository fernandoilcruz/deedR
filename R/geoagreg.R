...
#'
#' @param ag String. The aggregation category. There are  four valid options:
...
#'
#' @param sort String. This is used for sorting names from A to Z ("ASC") or Z to A ("DESC").Default is "ASC".
#'
#' @return a data.frame.
#' @export
#'
